...
class PlanetaControllerTest < ActionController::TestCase
  ...
  test "should create planetum" do
    assert_difference('Planetum.count') do
      post :create, planetum: { coordenadaa: @planetum.coordenadaa, coordenadab: @planetum.coordenadab, estado: @planetum.estado, nombre: @planetum.nombre, sistema: @planetum.sistema }
    end
  ...
  test "should update planetum" do
    patch :update, id: @planetum, planetum: { coordenadaa: @planetum.coordenadaa, coordenadab: @planetum.coordenadab, estado: @planetum.estado, nombre: @planetum.nombre, sistema: @planetum.sistema }
    assert_redirected_to planetum_path(assigns(:planetum))
  end
